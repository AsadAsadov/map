...
## Purpose
Bu fəsil ümumi səyahətdə oxucunu kainatın gələcəyi haqqında nə bilirik və nəyi bilmirik? sualına yaxınlaşdırır və əvvəlki mərhələdən növbəti intellektual/emotional mərhələyə keçirir. Final mətn yazılmır; məqsəd fəsildə hansı sualların, sərhədlərin və mənbə ehtiyaclarının olacağını dəqiqləşdirməkdir.

## Central Question
Kainatın gələcəyi haqqında nə bilirik və nəyi bilmirik?

## Core Idea
Kosmologiya müşahidələrə bağlı gələcək modelləri qurur.
...
- `ELMİN DEDİYİ`: genişlənmə, qaranlıq enerji, istilik ölümü, Big Rip/Crunch.
- `FƏLSƏFİ SUAL`: müvəqqəti kainatda məna.
- `HƏLƏ BİLMİRİK`: sərhədlər və açıq qalan məqamlar.
- Növbəti fəsilə körpü.

## Scientific Layer
Araşdırılacaq elmi mövzular: genişlənmə, qaranlıq enerji, istilik ölümü, Big Rip/Crunch. Mənbə prioriteti: rəsmi elmi institutlar, review məqalələri və dərslik səviyyəli mənbələr. Konsensus olmayan nöqtələr açıq göstərilməlidir.

## Philosophical Layer
Müzakirə olunacaq fəlsəfi xətt: müvəqqəti kainatda məna. Ən azı iki mövqe verilməli, qarşı tərəf zəifləşdirilməməlidir.

## Islamic Perspective
qiyamət elmi modellərlə qarışdırılmamalıdır. Quran ayəsi və ya hədis yalnız dəqiq surə/ayə, mənbə və kontekst yoxlanandan sonra istifadə edilə bilər. Quran elmi dərslik kimi təqdim edilməməlidir.
...
## Transition
Növbəti fəsil: Bizdən sonra Yer. Keçid sualı: bu fəslin açıq qoyduğu məsələ növbəti fəsildə hansı yeni tərəfdən görünəcək?

## Opening Scene
Oxucu Kainatın sonu sualına gündəlik bir səhnədən daxil olur: sakit, konkret və emosional şantajsız başlanğıc.
