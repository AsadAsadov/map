# Pul, ev, iş və qurduğumuz həyat

## Purpose
Bu fəsil ümumi səyahətdə oxucunu qurduğumuz həyat bizi qoruyur, yoxsa udur? sualına yaxınlaşdırır və əvvəlki mərhələdən növbəti intellektual/emotional mərhələyə keçirir. Final mətn yazılmır; məqsəd fəsildə hansı sualların, sərhədlərin və mənbə ehtiyaclarının olacağını dəqiqləşdirməkdir.
...
- `ELMİN DEDİYİ`: sosioiqtisadi stress, iş, status və rifah.
- `FƏLSƏFİ SUAL`: yadlaşma, instrumental həyat, modernlik.
- `HƏLƏ BİLMİRİK`: sərhədlər və açıq qalan məqamlar.
- Növbəti fəsilə körpü.

## Scientific Layer
Araşdırılacaq elmi mövzular: sosioiqtisadi stress, iş, status və rifah. Mənbə prioriteti: rəsmi elmi institutlar, review məqalələri və dərslik səviyyəli mənbələr. Konsensus olmayan nöqtələr açıq göstərilməlidir.

## Philosophical Layer
Müzakirə olunacaq fəlsəfi xətt: yadlaşma, instrumental həyat, modernlik. Ən azı iki mövqe verilməli, qarşı tərəf zəifləşdirilməməlidir.

## Islamic Perspective
mal, məsuliyyət, israf və ədalət. Quran ayəsi və ya hədis yalnız dəqiq surə/ayə, mənbə və kontekst yoxlanandan sonra istifadə edilə bilər. Quran elmi dərslik kimi təqdim edilməməlidir.
...
## Visual Direction
Vizual konsept: uşaq və səpələnmiş söz parçaları. Vizual dekorasiya yox, fəslin əsas sualını daşıyan məna elementi olmalıdır.

## Page Budget
Təxmini 4 səhifə. Vizual səhifələr bu büdcəyə daxildir.

## Transition
Növbəti fəsil: Xoşbəxtlik niyə tez keçir?. Keçid sualı: bu fəslin açıq qoyduğu məsələ növbəti fəsildə hansı yeni tərəfdən görünəcək?

## Opening Scene
Oxucu Pul, ev, iş və qurduğumuz həyat sualına gündəlik bir səhnədən daxil olur: sakit, konkret və emosional şantajsız başlanğıc.
